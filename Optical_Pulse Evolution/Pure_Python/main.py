...
def evolve_envelope(A, p21, X, t):
    ...
    """
    aux = eps*(A[2:] + A[:-2]) #+ gama*(p21*sp.exp(1j*(Kp*X - Wp*t)) + CC)
...
if __name__ == '__main__':
    ...
    A = (sp.exp(-((X-width/4.0)/0.75)**2)*sp.exp(1j*5.0)).astype(complex) # Initial envelope generated as random dist
